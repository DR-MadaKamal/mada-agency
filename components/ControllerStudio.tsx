...
const ControllerStudio: React.FC<ControllerStudioProps> = ({ project, setProject }) => {
    ...
    const handleGenerate = async () => {
        ...
        try {
            const result = await editImage(project.sourceImages[0], prompt, project.aiConfig);
            setProject(s => ({
                ...s,
