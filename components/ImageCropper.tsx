...
const ImageCropper: React.FC<ImageCropperProps> = ({ file, onConfirm, onCancel }) => {
    ...
    const getViewportRect = () => {
        ...
        // If ratio is 0 (Custom), we default to image ratio or square, 
        // but for simplicity in this strict editor, let's treat Custom as fitting the image initial ratio
